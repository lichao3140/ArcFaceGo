...
package com.arcsoft.asg.libdeviceadapt.view.seekbar;
...
public class SettingsSeekBar extends View {
    ...
    public SettingsSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.SettingsSeekBar);
        try {
            ...
            barHeightParam = getBarHeight(array);
    ...
    public SettingsSeekBar setCornerRadius(float cornerRadius) {
        this.cornerRadius = cornerRadius;
        return this;
    }

    public SettingsSeekBar setMinValue(float minValue) {
        this.minValue = minValue;
        this.absoluteMinValue = minValue;
        return this;
    }

    public SettingsSeekBar setMaxValue(float maxValue) {
        this.maxValue = maxValue;
        this.absoluteMaxValue = maxValue;
        return this;
    }

    public SettingsSeekBar setMinStartValue(float minStartValue) {
        this.minStartValue = minStartValue;
        return this;
    }

    public SettingsSeekBar setSteps(float steps) {
        this.steps = steps;
        return this;
    }

    public SettingsSeekBar setBarHeight(float barHeight) {
        this.barHeightParam = barHeight;
        return this;
    }

    public SettingsSeekBar setBarColorMode(int barColorMode) {
        this.barColorMode = barColorMode;
        return this;
    }

    public SettingsSeekBar setBarColor(int barColor) {
        this.barColor = barColor;
        return this;
    }

    public SettingsSeekBar setBarGradientStart(int barGradientStart) {
        this.barGradientStart = barGradientStart;
        return this;
    }

    public SettingsSeekBar setBarGradientEnd(int barGradientEnd) {
        this.barGradientEnd = barGradientEnd;
        return this;
    }

    public SettingsSeekBar setBarHighlightColorMode(int barHighlightColorMode) {
        this.barHighlightColorMode = barHighlightColorMode;
        return this;
    }

    public SettingsSeekBar setBarHighlightColor(int barHighlightColor) {
        this.barHighlightColor = barHighlightColor;
        return this;
    }

    public SettingsSeekBar setBarHighlightGradientStart(int barHighlightGradientStart) {
        this.barHighlightGradientStart = barHighlightGradientStart;
        return this;
    }

    public SettingsSeekBar setBarHighlightGradientEnd(int barHighlightGradientEnd) {
        this.barHighlightGradientEnd = barHighlightGradientEnd;
        return this;
    }

    public SettingsSeekBar setThumbColor(int leftThumbColorNormal) {
        this.thumbColorNormal = leftThumbColorNormal;
        return this;
    }

    public SettingsSeekBar setThumbHighlightColor(int leftThumbColorPressed) {
        this.thumbColorPressed = leftThumbColorPressed;
        return this;
    }

    public SettingsSeekBar setThumbDrawable(int resId) {
        setThumbDrawable(ContextCompat.getDrawable(getContext(), resId));
        return this;
    }

    public SettingsSeekBar setThumbDrawable(Drawable drawable) {
        setThumbBitmap(getBitmap(drawable));
        return this;
    }

    public SettingsSeekBar setThumbBitmap(Bitmap bitmap) {
        thumb = bitmap;
        return this;
    }

    public SettingsSeekBar setThumbHighlightDrawable(int resId) {
        setThumbHighlightDrawable(ContextCompat.getDrawable(getContext(), resId));
        return this;
    }

    public SettingsSeekBar setThumbHighlightDrawable(Drawable drawable) {
        setThumbHighlightBitmap(getBitmap(drawable));
        return this;
    }

    public SettingsSeekBar setThumbHighlightBitmap(Bitmap bitmap) {
        thumbPressed = bitmap;
        return this;
    }

    public SettingsSeekBar setDataType(int dataType) {
        this.dataType = dataType;
        return this;
    }

    public SettingsSeekBar setPosition(int pos) {
    ...
    protected float getThumbDiameter() {
        return (thumbDiameter > 0) ? thumbDiameter : getResources().getDimension(R.dimen.y20);
    }

    public float getBarHeight() {
        return barHeightParam;
    }

    public float getDiameter(final TypedArray typedArray) {
        return typedArray.getDimensionPixelSize(R.styleable.SettingsSeekBar_thumb_diameter, getResources().getDimensionPixelSize(R.dimen.y36));
    }

    protected boolean isSeekBarTouchEnabled(final TypedArray typedArray) {
        return typedArray.getBoolean(R.styleable.SettingsSeekBar_seek_bar_touch_enabled, false);
    }
    ...
    public void apply() {
        thumbWidth = (thumb != null) ? thumb.getWidth() : getResources().getDimension(R.dimen.y36);
        thumbHeight = (thumb != null) ? thumb.getHeight() : getResources().getDimension(R.dimen.y36);
        barHeight = barHeightParam;
    ...
    protected float getCornerRadius(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.SettingsSeekBar_corner_radius, 0f);
    }

    protected float getMinValue(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.SettingsSeekBar_min_value, 0f);
    }

    protected float getMaxValue(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.SettingsSeekBar_max_value, 100f);
    }

    protected float getMinStartValue(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.SettingsSeekBar_min_start_value, minValue);
    }

    protected float getSteps(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.SettingsSeekBar_steps, NO_STEP);
    }

    protected float getBarHeight(final TypedArray typedArray) {
        return typedArray.getDimensionPixelSize(R.styleable.SettingsSeekBar_bar_height, 0);
    }

    protected int getBarColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.SettingsSeekBar_bar_color_mode, ColorMode.SOLID);
    }

    protected int getBarColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.SettingsSeekBar_bar_color, Color.GRAY);
    }

    protected int getBarGradientStart(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.SettingsSeekBar_bar_gradient_start, Color.GRAY);
    }

    protected int getBarGradientEnd(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.SettingsSeekBar_bar_gradient_end, Color.DKGRAY);
    }

    protected int getBarHighlightColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.SettingsSeekBar_bar_highlight_color_mode, ColorMode.SOLID);
    }

    protected int getBarHighlightColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.SettingsSeekBar_bar_highlight_color, Color.BLACK);
    }

    protected int getBarHighlightGradientStart(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.SettingsSeekBar_bar_highlight_gradient_start, Color.DKGRAY);
    }

    protected int getBarHighlightGradientEnd(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.SettingsSeekBar_bar_highlight_gradient_end, Color.BLACK);
    }

    protected int getThumbColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.SettingsSeekBar_thumb_color, Color.BLACK);
    }

    protected int getThumbColorPressed(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.SettingsSeekBar_thumb_color_pressed, Color.DKGRAY);
    }

    protected Drawable getThumbDrawable(final TypedArray typedArray) {
        return typedArray.getDrawable(R.styleable.SettingsSeekBar_thumb_image);
    }

    protected Drawable getThumbDrawablePressed(final TypedArray typedArray) {
        return typedArray.getDrawable(R.styleable.SettingsSeekBar_thumb_image_pressed);
    }

    protected int getDataType(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.SettingsSeekBar_data_type, DataType.INTEGER);
    }

    protected final int getPosition(final TypedArray typedArray) {
        final int pos = typedArray.getInt(R.styleable.SettingsSeekBar_position, Position.LEFT);
    ...
    public void setSeekBarTouchEnabled(boolean seekBarTouchEnabled) {
        this.seekBarTouchEnabled = seekBarTouchEnabled;
    }
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        setupBar(canvas, paint, rectF);
        setupHighlightBar(canvas, paint, rectF);
        setupLeftThumb(canvas, paint, rectF);
    }
