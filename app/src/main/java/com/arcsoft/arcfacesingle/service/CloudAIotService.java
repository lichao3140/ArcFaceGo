...
public class CloudAIotService extends Service {

    static CloudServiceBinder binder;
    ...
    public static void start() {
        connection = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                binder = (CloudServiceBinder) service;
                binder.start();
            }
        ...
        Intent intent = new Intent(Utils.getApp(), CloudAIotService.class);
    ...
    public static void connectArcLink() {
        if (binder != null) {
            binder.connectArcLink();
        }
    }
