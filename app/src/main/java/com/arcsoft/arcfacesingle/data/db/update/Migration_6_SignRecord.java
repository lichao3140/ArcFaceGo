...
public class Migration_6_SignRecord extends AlterTableMigration<TableSignRecord> {

    public Migration_6_SignRecord(Class<TableSignRecord> signRecordClass) {
        super(signRecordClass);
    }

    @Override
    public void onPreMigrate() {
        addColumn(SQLiteType.TEXT, TableSignRecord_Table.icCardNo.getNameAlias().name());
    }
}
